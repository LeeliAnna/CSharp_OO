...
namespace Demo_static.Models
{
    internal class Formation
    {
        ...
        public void Decrire()
        {
            Console.WriteLine($"La formation est dénomée {nom}, et voici des élèves qui la suivent: ");
        ...
        {
            Console.WriteLine($"Ce programme regroupe l'ensemble des formations de {centre}.");
        } 
